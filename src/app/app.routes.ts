...
export const routes: Routes = [
  ...
  { path: 'tutores/novo', loadComponent: () => import('./pages/tutores/tutor-form/tutor-form.component').then((m) => m.tutoresFormComponent) },
  { path: 'tutores/:id', loadComponent: () => import('./pages/tutores/tutor-detail/tutor-detail.component').then((m) => m.tutoresDetailComponent) },
  { path: 'tutores/:id/editar', loadComponent: () => import('./pages/tutores/tutor-form/tutor-form.component').then((m) => m.tutoresFormComponent) },
